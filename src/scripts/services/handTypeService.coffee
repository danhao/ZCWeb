class Service
	...
	types = [
		{ name: 'M0', value: 0, text: 'M0', from: 0, to: 14, rate: 0.01 },
		{ name: 'M1', value: 1, text: 'M1', from: 15, to: 29, rate: 0.02 },
		{ name: 'M2', value: 2, text: 'M2', from: 30, to: 59, rate: 0.03 },
		{ name: 'M3', value: 3, text: 'M3', from: 60, to: 89, rate: 0.04 },
