		...
		karma:
			unit:
				options:
					...
					colors: true
					files: [
						# 'dist/scripts/libs/require.js'
						# 'dist/scripts/libs/angular.min.js'
						# 'dist/scripts/libs/jquery.min.js'
						# 'dist/scripts/libs/moment.js'
		...
		shimmer:
			dev:
				...
				src: [
					...
					'!libs/html5shiv-printshiv.min.{coffee,js}'
					'!libs/json3.min.{coffee,js}'
					'!libs/require.{coffee,js}'
					'!vendors.min.{coffee,js}'
			...
			scripts:
				files:
					...
					'.temp/scripts/vendors.min.js': [
						...
						# jquery
						'.temp/scripts/libs/jquery.min.js'
						'.temp/scripts/libs/bootstrap.min.js'
						'.temp/scripts/libs/bootstrap-notify.min.js'
						'.temp/scripts/libs/jquery.nicescroll.min.js'
						'.temp/scripts/libs/jquery.maskedinput.min.js'
						'.temp/scripts/libs/chosen.jquery.min.js'
						'.temp/scripts/libs/bootstrap-datetimepicker.min.js'
